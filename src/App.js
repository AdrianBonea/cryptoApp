...
function App() {
  const mockDataTicker = [
    { price: "$9,890.00", ticker: "BTC", name: "Bitcoin" },
    { price: "$9,890.00", ticker: "DOGE", name: "Dogecoin" },
    { price: "$9,890.00", ticker: "BCH", name: "Bitcoin Cash" },
    { price: "$9,890.00", ticker: "CHD", name: "Chadcoin" },
  ];
    ...
    <body>
      <div className="container mx-auto flex flex-col items-center bg-gray-100 p-4">
        ...
        <div className="container">
          <AddTicker key={mockDataTicker.name} ticker={mockDataTicker} />
